...
attributes = ['ethnicity', 'age', 'gender']
...
num_graphs = 1
graphnames = ['spa_500_{}'.format(graphidx) for graphidx in range(1)]#old=10
print(graphnames)
...
for graphname in graphnames:
    ...
    for run in range(num_runs):
        print(graphname, run)
        live_graphs = sample_live_icm(g, 100)#1000
        ...
        def f_multi(x):
            return val_oracle(x, 100).sum()#old=1000
        ...
        for attr_idx, attribute in enumerate(attributes):
            ...
            if succession:
                for vidx, val in enumerate(values):
                    ...
                    live_graphs_h = sample_live_icm(h, 100)#1000
            ...
            xg[list(S)] = 1
            greedy_vals = val_oracle(xg, 100)#1000
            all_fair_vals = val_oracle(fair_x, 100)#1000
            all_minmax_vals = val_oracle(minmax_x, 100)#1000
            if include_total:
